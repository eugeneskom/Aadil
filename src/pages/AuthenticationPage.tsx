...
function AuthenticationPage() {
  ...
  const authenticate = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/auth/register`,params);
          ...
          <div className="flex items-center justify-between">
            {isLogin && (
              <div className="text-sm">
                <button onClick={navigateToForgotPassword} className="font-medium text-indigo-600 hover:text-indigo-500">
            ...
            <div className="text-sm">
              {isLogin ? (
                <button onClick={navigateToRegister} className="font-medium text-indigo-600 hover:text-indigo-500">
                  Create an account
                </button>
              ) : (
                <button onClick={navigateToLogin} className="font-medium text-indigo-600 hover:text-indigo-500">
                  Sign in
                </button>
              )}
            </div>
